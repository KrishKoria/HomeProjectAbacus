...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <CaretDownIcon data-slot="accordion-trigger-icon" aria-hidden="true" className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden" />
        <CaretUpIcon data-slot="accordion-trigger-icon" aria-hidden="true" className="pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline" />
      </AccordionPrimitive.Trigger>
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="grid transition-[grid-template-rows] duration-200 ease-out grid-rows-[0fr] data-[open]:grid-rows-[1fr]"
      {...props}
    >
      <div
        className={cn(
