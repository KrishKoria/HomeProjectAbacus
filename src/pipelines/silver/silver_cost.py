...
BRONZE_COST_TABLE = "healthcare.bronze.cost"
SILVER_COST_TABLE = f"healthcare.{SILVER_SCHEMA_DEFAULT}.cost"
QUARANTINE_COST_TABLE = f"healthcare.{QUARANTINE_SCHEMA_DEFAULT}.cost"
